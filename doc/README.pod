...
[--config FILE] [--stoplist FILE] [--window INT]
...
Punctuation will be ignored, and compounds known to WordNet will be 
identified automatically (e.g., 'winston churchill' will be recognized 
as a compound and converted to winston_churchill).
...
# $Id: README.pod,v 1.12 2009/01/19 16:39:17 kvarada Exp $
