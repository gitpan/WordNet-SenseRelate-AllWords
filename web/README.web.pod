...
The web/htdocs/allwords directory contains one html script and user_data 
directory: 
...
$Id: README.web.pod,v 1.11 2008/11/14 05:48:30 tpederse Exp $ 

=head1 BUGS

If you give mal formatted config file, the error handling is not
properly. Your server won't die. You will see the error message
where allwords_server.pl is running. However, no proper error message
